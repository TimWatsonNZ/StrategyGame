...
/*!*****************!*\
  !*** ./Road.js ***!
  \*****************/
/*! exports provided: Road, Shapes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Road\", function() { return Road; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Shapes\", function() { return Shapes; });\n/* harmony import */ var _Cell__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Cell */ \"./Cell.js\");\n\r\n\r\nconst Shapes = {\r\n  isolated: 'isolated',\r\n  top: 'top',\r\n  left: 'left',\r\n  bottom: 'bottom',\r\n  right: 'right',\r\n  vertical: 'vertical',\r\n  horizontal: 'horizontal',\r\n  topRight: 'topRight',\r\n  topLeft: 'topLeft',\r\n  bottomRight: 'bottomRight',\r\n  bottomLeft: 'bottomLeft',\r\n  horizontalBottom: 'horizontalBottom',\r\n  horizontalTop: 'horizontalTop',\r\n  verticalLeft: 'verticalLeft',\r\n  verticalRight: 'verticalRight',\r\n  cross: 'cross'\r\n}\r\n\r\nclass Road {\r\n  constructor(type, cell, shape) {\r\n    this.type = type;\r\n    this.cell = cell;\r\n    this.shape = shape;\r\n  }\r\n\r\n  draw(context, cellSize) {\r\n    context.fillStyle = '#c48b23';\r\n\r\n    \r\n    switch (this.shape) {\r\n      case Shapes.isolated:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize + cellSize/4, cellSize/2, cellSize/2);\r\n        break;\r\n        \r\n      case Shapes.vertical:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize, cellSize/2, cellSize);\r\n        break;\r\n      \r\n      case Shapes.horizontal:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize, this.cell.drawingPoint.y * cellSize + cellSize/4, cellSize, cellSize/2);\r\n        break;\r\n        \r\n      case Shapes.left:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize, this.cell.drawingPoint.y * cellSize + cellSize/4, 3*cellSize/4, cellSize/2);\r\n        break;\r\n\r\n      case Shapes.right:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize + cellSize/4, 3*cellSize/4, cellSize/2);\r\n        break;\r\n\r\n      case Shapes.top:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize, cellSize/2, 3*cellSize/4);\r\n        break;\r\n\r\n      case Shapes.bottom:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize + cellSize/4, cellSize/2, cellSize/2);\r\n        break;\r\n\r\n      case Shapes.cross:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize, this.cell.drawingPoint.y * cellSize + cellSize/4, cellSize, cellSize/2);\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize, cellSize/2, cellSize);\r\n        break;\r\n\r\n      case Shapes.topLeft:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize, cellSize/2, cellSize/2);\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize, this.cell.drawingPoint.y * cellSize + cellSize/4, cellSize/2, cellSize/2);\r\n        break;\r\n\r\n      case Shapes.topRight:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize + cellSize/4, cellSize/2, cellSize/2);\r\n        break;\r\n\r\n      case Shapes.bottomLeft:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize + cellSize/4, cellSize/2, cellSize/2);\r\n        break;\r\n\r\n      case Shapes.bottomRight:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize + cellSize/4, cellSize/2, cellSize/2);\r\n        break;\r\n\r\n      case Shapes.verticalLeft:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize + cellSize/4, cellSize/2, cellSize/2);\r\n        break;\r\n\r\n      \r\n      case Shapes.verticalRight:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize + cellSize/4, cellSize/2, cellSize/2);\r\n        break;\r\n\r\n      case Shapes.horizontalTop:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize + cellSize/4, cellSize/2, cellSize/2);\r\n        break;\r\n\r\n      case Shapes.horizontalBottom:\r\n        context.fillRect(this.cell.drawingPoint.x * cellSize + cellSize/4, this.cell.drawingPoint.y * cellSize + cellSize/4, cellSize/2, cellSize/2);\r\n        break;\r\n    }\r\n  }\r\n}\r\n\r\n\n\n//# sourceURL=webpack:///./Road.js?");
